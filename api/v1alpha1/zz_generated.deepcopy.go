...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JobsToBeCloned) DeepCopyInto(out *JobsToBeCloned) {
	*out = *in
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobsToBeCloned.
func (in *JobsToBeCloned) DeepCopy() *JobsToBeCloned {
	if in == nil {
		return nil
	}
	out := new(JobsToBeCloned)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkflowSpec) DeepCopyInto(out *WorkflowSpec) {
	*out = *in
	if in.JobsToBeCloned != nil {
		...
		*out = make([]JobsToBeCloned, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
