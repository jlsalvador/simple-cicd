...
func init() {
	...
	utilruntime.Must(simplecicdv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8bdb872b.jlsalvador.online",
	...
	if err = (&controller.WorkflowWebhookReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "WorkflowWebhook")
		os.Exit(1)
	}
	if err = (&controller.WorkflowWebhookRequestReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "WorkflowWebhookRequest")
		os.Exit(1)
	}
	...
	if err := ctx.Err(); err != nil {
		setupLog.Error(err, "unexpected error")
		os.Exit(1)
	}
}
